...
xlabel('Time (s)');
    ...
    dlmwrite(strcat('ThirdStageStates',namelist{j}),[[time3; time3(end)+timeexo'], [alt3; altexo'], [v3; v3exo'], [m3; mexo'; mexo(end)],[q3; qexo'; qexo(end)] ,[gamma3; gammaexo'],[L3; Lexo'; Lexo(end)],[D3; Dexo'; Dexo(end)] ,[zeta3; zetaexo'], [lat3; latexo'], [aoa3; zeros(length(timeexo),1)] , [Kn3; Knexo']],'-append','delimiter',' ')
...
Isp1 = Vehicle.Isp.SL;
T121 = Vehicle.T.SL.*1; % Throttle is set to 1 for prepitch
dm1 = -T121./Isp1./9.81;
...
addaxis(time1-time1(1),T121/1000,'--','color','k', 'linewidth', 1.);
ylabel('Thrust (kN)');
...
addaxis(time1-time1(1),(T121-D1)./-dm1,'--','color','k', 'linewidth', 1.);
...
FlowProps = [[time1'; time21; time22] [alt1'; alt21; alt22] [M1'; M21;M22] [T01';T021;T022] [P01';P021;P022] [rho01';rho021;rho022]  [M_1_tip1';M_1_tip21';M_1_tip22'] [T_1_tip1';T_1_tip21';T_1_tip22'] [P_1_tip1';P_1_tip21';P_1_tip22'] [rho_1_tip1';rho_1_tip21';rho_1_tip22'] [v_1_tip1';v_1_tip21';v_1_tip22'] [heating_rate1';heating_rate21;heating_rate22] [heating_rate_LE1';heating_rate_LE21;heating_rate_LE22]  [ones(length(alt1),1);2*ones(length(alt21),1);3*ones(length(alt22),1)] St_forebody St_wing St_shroud St_tail];
dlmwrite(strcat('FlowProps',namelist{j}),['time(s) ' 'altitude(m) ' 'Mach ' 'IncomingAirTemp(K)' ' IncomingAirPressure(Pa)' ' IncomingAirdensity(kg/m^3)' ' Machno.AfterNormalShock' ' TemperatureAfterNormalShock(K)'  ' PressureAfterNormalShock(Pa)' ' DensityAfterNormalShock(kg/m^3)' ' VelocityAfterNormalShock(m/s)' ' heatingrate(w/m^2)' ' heatingrateLE(w/m^2)' ' Phase(first-second-return)'  ' St_forebody' ' St_wing' ' St_shroud' ' St_tail'],'');   
...
[altdot21,xidot21,phidot21,gammadot21,a21,zetadot21, q21nom, M21, Fd21, rho021,L21,Fueldt21,T21,Isp21,q121,flapdeflection21,heating_rate21,CG21,T121,P121,M121,P021,T021,P_1_tip21,T_1_tip21,rho_1_tip21,M_1_tip21] = SPARTANDynamics(gamma21nom, alt21nom, v21nom,auxdata,zeta21nom,lat21nom,lon21nom,alpha21nom,eta21nom,ones(length(alt21nom),1), mFuel21nom,mFuel21nom(1),mFuel21nom(end), 1, 0);
