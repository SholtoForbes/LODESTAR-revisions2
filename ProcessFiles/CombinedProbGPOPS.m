...
if mode == 1000
    for i = 1:length(Hypercube(:,1))  
        ...
        setup_variations{i}.auxdata.Ca3mod = unc.Ca3/100*(Hypercube(i,7)-0.5)*2 ;
        setup_variations{i}.auxdata.Cn3mod = unc.Cn3/100*(Hypercube(i,8)-0.5)*2 ;
        setup_variations{i}.auxdata.Cm3mod = unc.CM3/100*(Hypercube(i,9)-0.5)*2 ;
        setup_variations{i}.auxdata.Isp3mod = unc.ISP3/100*(Hypercube(i,10)-0.5)*2 ;
