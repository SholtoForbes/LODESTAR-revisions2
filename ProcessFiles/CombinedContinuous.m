...
[dz1,q1,xi1] = FirstStageDynamics(x,u,t,phase,interp,Vehicle,Atmosphere,auxdata); % Pass primal variables into dynamics simulator
...
throttle21  = 1*ones(length(alt21),1);
...
[altdot22,londot22,latdot22,fpadot22,vdot22,azidot22, q22, M22, Fd, rho,L,Fueldt22,T22,Isp22,q22_aftershock,flap_deflection22,heating_rate22] = SPARTANDynamics(fpa22, alt22, v22,auxdata,azi22,lat22,lon22,aoa22,bank22,throttle22, mFuel22,0,0,0, 0);
...
phaseout(3).path = [q22,heating_rate22*10^-3] ;
